...
public class Game {
   ...
   public static PieceDepot pieceDepot = new PieceDepot();
            ...
            if(keypr==0) {
               keypr=1;
                ...
                if(e.getKeyCode()=='9' && control==0){
                    ...
                    crobot1.powers();
                    writePiece.Inf_area(crobot1);
                    setCursor(1,36);
                    write("Computer Robot 1");
                    setCursor(1, 45);
                ...
                if(e.getKeyCode()=='9' && control==2){
                    ...
                    crobot2.creatComputerRobot();
                    writePiece.writeToScreenRobot(crobot2, 2, 2);
                    crobot2.powers();
                    writePiece.Inf_area(crobot2);
                    setCursor(1,36);
                    write("Computer Robot 2");
                    setCursor(1, 45);
                    write("Computer Robot 2 (CR2)");
                    setCursor(1, 46);
                    write("In:" + Math.floor(crobot2.getIntelligence()) + "  Sk:" + Math.floor(crobot2.getSkill()) + "  Sp:" + Math.floor(crobot2.getSpeed()));
                    control ++;
